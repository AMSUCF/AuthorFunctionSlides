/* ============================================
   ...
   45 minutes total, per-scene duration overrides
   ============================================ */

const Autoplay = (() => {
  const TOTAL_MS = 45 * 60 * 1000; // 2,700,000ms
  const SCENE_DURATION_OVERRIDES = { 46: 60000 }; // animation scene: 60 seconds
  let _playing = false;
  let _startTime = null;
  let _elapsed = 0;
  let _timer = null;
